...
public class StartMethodActivity extends BaseActivity {

    static final int requestCode =2008;
    ...
    public void startActivityHide(View view) {

        Intent intent = new Intent("bjpkten.p_activitystatusthemeorientationrestore");

        startActivity(intent);
    }

    public void startActivityForResultMethod(View view) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == StartMethodActivity.requestCode&&resultCode == ResultActivity.resultCode){
